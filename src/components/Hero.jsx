    ...
    <div className="relative z-10 mt-20 flex flex-col items-center justify-center px-4 text-center md:mt-20">
      ...
      <div className="mb-10 mt-4 md:mt-6">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <a href="/Amit_Doanias_CV_EN.pdf" download="Amit_Doanias_CV.pdf">
            <Button size="lg">
          ...
          <a href="/Amit_Doanias_CV_HE.pdf" download="עמית_דואניאס_קורות_חיים.pdf">
...
const darkSocialLinks = [
  ...
  {
    label: 'CV (EN)',
    href: '/Amit_Doanias_CV_EN.pdf',
    download: 'Amit_Doanias_CV.pdf',
    icon: (
